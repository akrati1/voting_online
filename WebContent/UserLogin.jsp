...
<input type="password" pattern="[A-z a-z 0-9]{5,10}" size="10" name ="upass" class="input-field" placeholder="Enter Password" title="Enter at least 5-letter and max 10-letter password :Don't use special characters " required>
<button type="submit" class="submit-btn">Login</button>
</form>
<span>New User?</span> <a href="RegisterVoter.jsp">Register</a>
</div>
</header>
