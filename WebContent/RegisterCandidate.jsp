...
<div class="form-box">
<h1 id="Candidate-Register">Candidate Registration</h1>
<form action="CandidateAddS.jsp" class = "input-group">
...
<input type="text" pattern="^[0-9]{10}$" size="10" name="candEnrollId" class="input-field" placeholder="Candidate Enrollment Id" title="Enter Valid 10-digit Candidate Enrollment Id" autocomplete="off" required>
<input type="text" pattern="([a-zA-Z]| |-|\$|,|&){3,30}" size="30" name="party_Affiliation" class="input-field" placeholder="party_Affiliation" title="Enter Valid Party Name" autocomplete="off" required>


<!--  <input type="text" name="party_Affiliation" class="input-field" placeholder="Party Affiliation" required> -->
...
<input type="password" pattern="[A-z a-z 0-9]{5,10}" size="10" name ="user_Password" class="input-field" placeholder="User Password" title="Enter at least 5-letter and max 10-letter password" required>
...
<span>Already a user?</span><a href="CandidateLogin.jsp">Login</a>
</form>
</div>
</header>
</body>
